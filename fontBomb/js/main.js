(function() {
  ...
  Particle = (function() {
    ...
    Particle.prototype.tick = function(blast) {
      ...
      if (this.velocityX > 0.3) {	//scope of fontBomb, default "1.5"
        this.velocityX -= 0.3;
  ...
  Bomb = (function() {
    ...
    Bomb.prototype.drop = function() {
      ...
      return setTimeout(this.countDown, 20);	//bombTime, default "1000"
    };
    ...
    Bomb.prototype.countDown = function() {
      ...
      this.bomb.innerHTML = this.count;
      if (this.count > 0) {
        return setTimeout(this.countDown, 20);
      } else {
        return this.explose();
      }
    };
